...
riguarda la feature \textit{Homogeneity}, la correlazione positiva non risulta 
coerente con la semantica delle metriche perché si dovrebbe osservare una 
correlazione negativa. La relazione positiva dei dati potrebbe essere una conseguenza 
di come sono state calcolate le feature.
